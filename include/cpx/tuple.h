...
namespace cpx {
    ...
    CPX_EXPORT template <typename F, typename Tuple>
    ...
    CPX_EXPORT template <typename Tuple, template <typename> typename Pred>
    struct filter_tuple;
    ...
    CPX_EXPORT template <typename Tuple, typename F>
    ...
    CPX_EXPORT template <template <typename> class Pred, typename T>
    ...
    CPX_EXPORT template <template <typename> class Pred, typename... Ts>
