...
TEST(sqlite3, workflow) {
...

    {
        ...
        auto stmt = sql::insert_into<employees>(employees.name, employees.salary, employees.bonus)
...

    {
        ...
        std::multimap<int, Person::User *, std::greater<>> expect = {
...

    {
        ...
        std::multimap<int, Person::Employee *, std::less<>> expect = {
